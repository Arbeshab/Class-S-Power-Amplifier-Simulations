...
##MGT Wrapper
vcom -93 -work work  ../../../gtx_output_tile.vhd;
vcom -93 -work work  ../../../gtx_output.vhd;
...
vcom -93 -work work  ../../example_design/gtx_output_top.vhd;
...
##Load Design
vsim -t 100fs work.DEMO_TB -voptargs="+acc" 
