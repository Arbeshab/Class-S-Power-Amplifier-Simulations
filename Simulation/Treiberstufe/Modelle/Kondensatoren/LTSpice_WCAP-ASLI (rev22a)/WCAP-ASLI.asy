...
SYMATTR Description WCAP-ASLI Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ASLI \n\nPlease note disclaimer in WCAP-ASLI.lib.
SYMATTR InstName C
SYMATTR SpiceModel 865080140001_22uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ASLI.lib
PIN -32 0 NONE 8
PINATTR PinName 1
